...
By clickpassword = By.id("input-password");
By clicklogin = By.xpath("//form[contains(@action,'login')]//input[@type='submit']");
By clickMyAccount = By.xpath("//span[contains(text(),'My Account')]");
By clickLogOut = (By.xpath("//h1[contains(text(),'Account Logout')]"));
